...
def greengrass_infinite_infer_run():
    try:
        ...
        while doInfer:
            ...
            if not onCountdown:
                cv2.putText(frame,
                            "Wait for picture: " + str(max(0, int((cooldown - time_now).total_seconds()))) + " seconds",
                ...
                if int((countdown - time_now).total_seconds()) >= -5:
                    ...
                    cv2.putText(frame, str(max(0, int((countdown - time_now).total_seconds()))) + "...", (1200, 1100),
                                font, 3, rgb_color, 4)
                else:
                    onCountdown = False
